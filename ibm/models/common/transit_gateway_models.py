...
class TransitGateway(Base):
    ...
    resource_group_id = Column(String(32), ForeignKey("ibm_resource_groups.id", ondelete="SET NULL"),
                               nullable=True)  # TODO Change this to ondelete="CASCADE"
...
class TransitGatewayConnection(Base):
    ID_KEY = "id"
    NAME_KEY = "name"
    VPC_KEY = "vpc"
    REGION_KEY = "region"
    ...
    transit_gateway_id = Column(String(32), ForeignKey("transit_gateways.id", ondelete="CASCADE"))
